...
import {ExtendedCommit} from "../types/types_pb.js";
...
export class BlockResponse extends Message$1<BlockResponse> {
  ...
  /**
   * @generated from field: tendermint.types.ExtendedCommit ext_commit = 2;
   */
  ...
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    ...
    { no: 2, name: "ext_commit", kind: "message", T: ExtendedCommit },
  ]);
