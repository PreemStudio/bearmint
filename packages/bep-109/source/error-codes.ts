export enum ErrorCode {
	...
	CMT_QUERY_FAULTY = 'ERR_CMT_QUERY_FAULTY',
	// An account was requested, but no identifier was provided.
	CMT_QUERY_MISSING_ACCOUNT_IDENTIFIER = 'ERR_CMT_QUERY_MISSING_ACCOUNT_IDENTIFIER',
	// An application state query was sent without details on what state is being requested.
	CMT_QUERY_MISSING_APP_ACTION = 'ERR_CMT_QUERY_MISSING_APP_ACTION',
	// A P2P query was sent without details on what action should occur.
	CMT_QUERY_MISSING_P2P_ACTION = 'ERR_CMT_QUERY_MISSING_P2P_ACTION',
	// A transaction was requested, but no identifier was provided.
	CMT_QUERY_MISSING_TRANSACTION_HASH = 'ERR_CMT_QUERY_MISSING_TRANSACTION_HASH',
	// An unknown query was requested.
	CMT_QUERY_UNKNOWN = 'ERR_CMT_QUERY_UNKNOWN',
