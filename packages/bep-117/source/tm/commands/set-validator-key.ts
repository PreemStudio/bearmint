...
export class SetValidatorKeyCommand extends Command {
	...
	public readonly description = 'Set the contents of ~/.cometbft/config/priv_validator_key.json'
	...
	async execute() {
		...
		// Act
		file.writeJson(Paths.CMT_PATH_CONF_PRIV_VALIDATOR_KEY, {
		...
		file.writeJson(Paths.CMT_PATH_DATA_PRIV_VALIDATOR_STATE, {
			height: '0',
			round: 0,
			step: 0,
		})
