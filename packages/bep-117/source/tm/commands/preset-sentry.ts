...
/**
 * @see https://docs.cometbft.com/master/nodes/validators.html#sentry-node-configuration
 */
export class PresetSentryCommand extends Command {
	...
	async execute() {
		...
		file.remove(Paths.CMT_PATH_CONF_PRIV_VALIDATOR_KEY)
		file.remove(Paths.CMT_PATH_DATA_PRIV_VALIDATOR_STATE)
	}
}
