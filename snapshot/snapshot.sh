...
info "Stopping ${CMT_SERVICE_NAME}"
sudo supervisorctl start ${CMT_SERVICE_NAME}:*
...
info "Starting ${CMT_SERVICE_NAME}"
sudo supervisorctl restart ${CMT_SERVICE_NAME}:*
